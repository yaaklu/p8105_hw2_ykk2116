...
_Distinct stations, stations which are ADA complaint_
...
**The dataset has `r nrow(distinct(brfss_data, locationabbr))` unique locations. Yes, every state is represented in the dataset. It also contains the federal district of the United States, District of Columbia.** 
